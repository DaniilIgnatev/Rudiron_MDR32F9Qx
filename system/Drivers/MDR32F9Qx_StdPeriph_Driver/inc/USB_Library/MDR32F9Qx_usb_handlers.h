...
/** @addtogroup  USB_Virtual_COM_Port_Echo_91 USB Virtual COM GPIO Echo
  * @{
  */
...
/** @defgroup USB_Virtual_COM_Port_Echo_Handlers USB Virtual COM GPIO Echo Handlers
  * @{
  */
...
/** @defgroup USB_Virtual_COM_Port_Echo_Handler_Functions USB Virtual COM GPIO Echo Handler Functions
  * @{
  */
