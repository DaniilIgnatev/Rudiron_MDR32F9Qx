...
#define PORT_JTAG                   MDR_PORTB    /*!< GPIO containing JTAG interface */
#define PORT_JTAG_Msk               0x001FU      /*!< JTAG pins */

#elif defined (USE_JTAG_B)
#define PORT_JTAG                   MDR_PORTD    /*!< GPIO containing JTAG interface */
#define PORT_JTAG_Msk               0x001FU      /*!< JTAG pins */

#elif defined (USE_SWD_A)
#define PORT_JTAG                   MDR_PORTB    /*!< GPIO containing SWD interface */
#define PORT_JTAG_Msk               0x0006U      /*!< SWD pins SWDIO and SWCLK */

#elif defined (USE_SWD_B)
#define PORT_JTAG                   MDR_PORTD    /*!< GPIO containing SWD interface */
#define PORT_JTAG_Msk               0b010011     /*!< SWD pins SWDIO and SWCLK */
