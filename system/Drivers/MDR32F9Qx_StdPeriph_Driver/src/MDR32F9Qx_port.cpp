...
/**
  ...
  * @param  PORTx: where x can be (A..F) to select the PORT peripheral.
  * @param  PORT_Pin: specifies the gpio bit to read.
...
/**
  * @brief  Reads the specified PORT input data gpio.
  * @param  PORTx: where x can be (A..F) to select the PORT peripheral.
  * @retval PORT input data gpio value. Bits (16..31) are always 0.
  */
...
/**
  * @brief  Sets the selected data gpio bits.
  * @param  PORTx: where x can be (A..F) to select the PORT peripheral.
  * @param  PORT_Pin: specifies the gpio bits to be written.
...
/**
  * @brief  Clears the selected data gpio bits.
  * @param  PORTx: where x can be (A..F) to select the PORT peripheral.
  * @param  PORT_Pin: specifies the gpio bits to be written.
  *         This parameter can be any combination of PORT_Pin_x where x can be (0..15).
  * @retval None
...
/**
  * @brief  Sets or clears the selected data gpio bit.
  * @param  PORTx: where x can be (A..G) to select the PORT peripheral.
  * @param  PORT_Pin: specifies the gpio bit to be written.
  *         This parameter can be one of PORT_Pin_x where x can be (0..15).
  * @param  BitVal: specifies the value to be written to the selected bit.
  *         This parameter can be one of the BitAction enum values:
  *           @arg Bit_RESET: to clear the gpio pin
  *           @arg Bit_SET: to set the gpio pin
  * @retval None
  */
...
/**
  * @brief  Writes data to the specified PORT data gpio.
  * @param  PORTx: where x can be (A..F) to select the PORT peripheral.
  * @param  PortVal: specifies the value to be written to the gpio output data register.
